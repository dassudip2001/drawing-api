...
categoryRoute.post('/category',authMiddleware,validate(createCategorySchema),create);
categoryRoute.get('/category/:id',authMiddleware, find);
categoryRoute.put('/category/:id',authMiddleware,validate(updateCategorySchema),update);
